...
public class TelaNovoUsuario extends javax.swing.JDialog {
    ...
    private boolean verificaCamposPreenchidos(){
        ...
        if(campoDiretorioCasos.getText().isEmpty()){
            JOptionPane.showMessageDialog(this, "Selecione um diretório para salvar os casos!");
            return false;
        }
    ...
    private void preencheObjetoUsuario(){
        novoUsuario = new Usuario(campoLogin.getText(),
                                  String.valueOf(campoSenha.getPassword()),
                                  campoNome.getText(), 
                                  campoDiretorioCasos.getText());
    }
    ...
    private void initComponents() {
        ...
        botaoSelecionarDiretorio.setText("SELECIONAR PASTA");
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                ...
                                .addComponent(campoDiretorioCasos, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 312, Short.MAX_VALUE)))
