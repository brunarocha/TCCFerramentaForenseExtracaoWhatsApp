...
public class TelaAlterarCaso extends javax.swing.JDialog {
    ...
    private void preencheDadosTela(){
        ...
        labelNomeInvestigado.setText(caso.getNomeInvestigado());
        labelDataCriacao.setText(ConversorData.getStringDeCalendar(caso.getDataCriacao()));
    }
    ...
    private void botaoSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botaoSalvarActionPerformed
        ...
        if(!verificaUsuariosSelecionados().isEmpty()){
            for(Usuario usuarioSelecionado : verificaUsuariosSelecionados()){
                casoDAO.relacionaCasoUsuario(TipoAcesso.Visualizar, usuarioSelecionado.getId(), caso.getId());
            }
        }
