        ...
        try {
            ...
            while(br.ready()){
                ...
                if(linha.contains("ro.product.display")){
                    dispositivo.setNumeroModelo(linha.substring(linha.indexOf("=")+1));
                }
                
                if(linha.contains("ro.build.version.full")){
                    dispositivo.setVersaoSistema(linha.substring(linha.indexOf("=")+1));
                }
                
                if(linha.contains("ro.build.id")){
                    dispositivo.setNumeroVersao(linha.substring(linha.indexOf("=")+1));
                }
                ...
                if(linha.contains("ro.build.version.release")){
                    dispositivo.setVersaoAndroid(linha.substring(linha.indexOf("=")+1));
                }
            }
